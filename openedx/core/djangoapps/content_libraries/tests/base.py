...
requires_blockstore_app = unittest.skipUnless(blockstore_api.config.use_blockstore_app(), "Requires blockstore app")


class BlockstoreAppTestMixin:
    """
    Sets up the environment for tests to be runn using the installed Blockstore app.
    """
    def setUp(self):
        """
