...
(function() {
    ...
    this.Sequence = (function() {
        ...
        Sequence.prototype.renderDropdown = function() {
          ...
          this.$(`#sequence-list > li.sequence-list-item:gt(${overFlowIdx})`).each((idx, el) => {
            ...
            navButton.find("span.icon").after(
              HtmlUtils.joinHtml(
                HtmlUtils.HTML('<span class="unit-title">'),
                unitTitle,
                HtmlUtils.HTML('</span>')
              ).toString()
            );
        ...
        Sequence.prototype.toggleDropdown = function() {
          this.$('#dropdown-sequence-list').toggle();
          this.$('#dropdown-sequence-list-button').attr({
            'aria-expanded': this.$('#dropdown-sequence-list').is(":visible")
          });
          if (this.$('#dropdown-sequence-list').is(":visible")) {
            this.$('#dropdown-sequence-list li button:first').focus();
          }
        }
