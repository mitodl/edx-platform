...
urlpatterns = patterns(
    ...
    url(r'^get_non_staff_enrollments',
        'lms.djangoapps.instructor.views.api.get_non_staff_enrollments', name="get_non_staff_enrollments"),
    ...
    url(r'^add_enrollments_using_remote_gradebook',
        'lms.djangoapps.instructor.views.api.add_enrollments_using_remote_gradebook', name="add_enrollments_using_remote_gradebook"),
